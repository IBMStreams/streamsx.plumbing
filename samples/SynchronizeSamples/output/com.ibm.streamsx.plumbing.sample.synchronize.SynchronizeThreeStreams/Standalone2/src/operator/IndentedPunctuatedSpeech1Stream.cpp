...
#include "./IndentedPunctuatedSpeech1Stream.h"
...
void MY_OPERATOR_SCOPE::MY_OPERATOR::process(Tuple const & tuple, uint32_t port) 
{
   ...
   if (! ((iport$0.get_outputDirectory() != lit$0)) ) 
       return;
   { OPort0Type otuple(iport$0.get_outputDirectory(), iport$0.get_outputFilename(), lit$1, iport$0.get_phrase(), iport$0.get_start(), iport$0.get_duration()); submit (otuple, 0);
 }
...
bool MY_BASE_OPERATOR::globalIniter() {
    instantiators_.insert(std::make_pair("IndentedPunctuatedSpeech1Stream",&initer));
    return true;
}
