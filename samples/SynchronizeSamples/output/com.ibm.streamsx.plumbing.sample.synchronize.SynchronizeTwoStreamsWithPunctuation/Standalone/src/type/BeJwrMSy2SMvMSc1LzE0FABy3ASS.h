...
#ifndef BEJWRMSY2SMVMSC1LZE0FABY3ASS_H_
#define BEJWRMSY2SMVMSC1LZE0FABY3ASS_H_
...
#define SELF BeJwrMSy2SMvMSc1LzE0FABy3ASS
...
public:
    ...
    SELF() : Tuple(), filename_() {}
    SELF(const Self & ot) : Tuple(), filename_(ot.filename_) 
      { constructPayload(ot); }
    SELF(const filename_type & _filename) : Tuple(), filename_(_filename) { }
    ...
    {
        size_t s = 17;
        s = 37 * s + std::tr1::hash<filename_type >()(filename_);
        return s;
    }
...
#undef SELF
#endif // BEJWRMSY2SMVMSC1LZE0FABY3ASS_H_ 
