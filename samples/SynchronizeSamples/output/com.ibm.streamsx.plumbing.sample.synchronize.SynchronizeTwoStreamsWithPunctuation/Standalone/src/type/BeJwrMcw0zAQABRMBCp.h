...
#ifndef BEJWRMCW0ZAQABRMBCP_H_
#define BEJWRMCW0ZAQABRMBCP_H_
...
#define SELF BeJwrMcw0zAQABRMBCp
...
public:
    ...
    SELF() : Tuple(), i_() {}
    SELF(const Self & ot) : Tuple(), i_(ot.i_) 
      { constructPayload(ot); }
    SELF(const i_type & _i) : Tuple(), i_(_i) { }
